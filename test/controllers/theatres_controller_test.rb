...
class TheatresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theatre" do
    assert_difference('Theatre.count') do
      post theatres_url, params: { theatre: { name: @theatre.name, seat_limit: @theatre.seat_limit } }
    end
  ...
  test "should update theatre" do
    patch theatre_url(@theatre), params: { theatre: { name: @theatre.name, seat_limit: @theatre.seat_limit } }
